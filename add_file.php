    ...
    <div class="container">
      <div class="row"><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          ...
          <footer style="font-size: 11px"><b>File Type:</b><font color="red"><i>  .pdf  </i></font></footer>
        </form>
      </div>
...
<!-- Material form login -->
   <Br>
    ...
    <div class="footer-copyright py-3">
        <p>All right Reserved &copy; <?php echo date('Y');?> Created By:<font color="#F0B56F"><b>CAROLINE</b></font></p>
    </div>
    <!--/.Copyright-->
