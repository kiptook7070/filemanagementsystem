...
<tbody>
    ...
    <tr>
      ...
      <td><?php echo $download; ?></td>
        ...
        <td>
             <td style=""><a href='downloads.php?file_id=<?php echo $id; ?>'><img src="img/698569-icon-57-document-download-128.png" width="30px" height="30px" title="Download File"></a> <td style=""><a href='../uploads/<?php echo  $name; ?>'><img src="img/View.png" width="30px" height="30px" title="View File"></a> </td>
    </tr>
<?php } ?>
</tbody>
   </table>
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
    ...
    <div class="">
     ...
     <div class=""><p><b style="font-size: 1.1em">Full Name:</b> CAROLINE CHEBET</p></div>
     <div class=""><p><b style="font-size: 1.1em">UNIVERSITY:</b> MMUST</p></div>
  ...
  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><h6 style="font-size: 1.1em">Contact Number</h6><Hr><br><div class=""><p><b style="font-size: 1.1em">Phone :</b> +254797434977</p></div><p><b style="font-size: 1.1em">Address :</b> KAKAMEGA</p>
</div><hr><br>
<!--   <div class="card">
